// Package model defines the DataKeeper script AST shared by generated typed
// reducer contexts, compiler code, and runtime reporting.
//
// Generated Go parsers live in a child package. Keeping AST-only types here
// lets both the generated parser and the public datakeeper package depend on a
// common model package without creating an import cycle.
package model
