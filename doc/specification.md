...
| `%semantic go import alias "module/path"` | Declare a target-specific handwritten semantic dependency. In Go inline mode this becomes a generated import. In reducer mode it is recorded as metadata for the handwritten reducer layer. |
