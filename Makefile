...
examples-generate:
	...
	$(MAKE) -C examples/templates/csharp/layered-compiler GO=$(GO) DOTNET=$(DOTNET) generate
	...
	$(MAKE) -C examples/templates/cpp/layered-compiler GO=$(GO) CXX=$(CXX) generate
...
examples-run:
	...
	$(MAKE) -C examples/templates/csharp/layered-compiler GO=$(GO) DOTNET=$(DOTNET) run
	...
	$(MAKE) -C examples/templates/cpp/layered-compiler GO=$(GO) CXX=$(CXX) run
...
examples-parity:
	...
	$(GO) run ./cmd/check-example-action-parity

examples-action-parity:
	$(GO) run ./cmd/check-example-action-parity
...
examples-templates:
	...
	$(MAKE) -C examples/templates/csharp/layered-compiler GO=$(GO) DOTNET=$(DOTNET) test
...
examples-benchmarks-verbose:
	@$(MAKE) --no-print-directory -C examples/benchmarks GO=$(GO) DOTNET=$(DOTNET) CC=$(CC) CXX=$(CXX) BENCH_TIME=$(BENCH_TIME) BENCH_COUNT=$(BENCH_COUNT) BENCH_PATTERN='$(BENCH_PATTERN)' REPORT_DIR='$(BENCH_REPORT_DIR)' CSHARP_BENCH_CONFIGURATION=$(CSHARP_BENCH_CONFIGURATION) CSHARP_BENCH_FILTER='$(CSHARP_BENCH_FILTER)' CSHARP_BENCH_JOB='$(CSHARP_BENCH_JOB)' CSHARP_BENCH_ARTIFACTS='$(CSHARP_BENCH_ARTIFACTS)' verbose
...
examples-benchmarks-csharp:
	@$(MAKE) --no-print-directory -C examples/benchmarks GO=$(GO) DOTNET=$(DOTNET) CSHARP_BENCH_CONFIGURATION=$(CSHARP_BENCH_CONFIGURATION) CSHARP_BENCH_FILTER='$(CSHARP_BENCH_FILTER)' CSHARP_BENCH_JOB='$(CSHARP_BENCH_JOB)' CSHARP_BENCH_ARTIFACTS='$(CSHARP_BENCH_ARTIFACTS)' csharp-required

examples-benchmarks-report:
	@$(MAKE) --no-print-directory -C examples/benchmarks GO=$(GO) DOTNET=$(DOTNET) BENCH_TIME=$(BENCH_TIME) BENCH_COUNT=$(BENCH_COUNT) BENCH_PATTERN='$(BENCH_PATTERN)' REPORT_DIR='$(BENCH_REPORT_DIR)' CSHARP_BENCH_CONFIGURATION=$(CSHARP_BENCH_CONFIGURATION) CSHARP_BENCH_FILTER='$(CSHARP_BENCH_FILTER)' CSHARP_BENCH_JOB='$(CSHARP_BENCH_JOB)' CSHARP_BENCH_ARTIFACTS='$(CSHARP_BENCH_ARTIFACTS)' report
...
examples-clean:
	...
	$(MAKE) -C examples/templates/csharp/layered-compiler clean
	...
	$(MAKE) -C examples/templates/cpp/layered-compiler clean
